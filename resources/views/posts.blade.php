<x-layout :title="$title">
  ...
  <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 mb-6">
      <div class="p-6">
          ...
          <p class="text-sm text-gray-600 mb-4">Oleh <span class="font-medium text-gray-700 hover:underline"><a href="/author/{{ $post->author->username }}">{{ $post->author->name }}</a></span>| {{ $post->created_at }}</p>
